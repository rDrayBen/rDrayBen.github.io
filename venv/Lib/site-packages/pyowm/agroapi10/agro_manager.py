...
class AgroManager:
    ...
    def search_satellite_imagery(self, polygon_id, acquired_from, acquired_to, img_type=None, preset=None,
        ...
        """
        Searches on the Agro API the metadata for all available satellite image that contain the specified polygon and
        ...
        :param img_type: the desired file format type of the image. Allowed values are given by `pyowm.commons.enums.ImageTypeEnum`
        :type img_type: `pyowm.commons.databoxes.ImageType`
        :param preset: the desired preset of the image. Allowed values are given by `pyowm.agroapi10.enums.PresetEnum`
        :type preset: str
        :param min_resolution: minimum resolution for image, px/meters
        :type min_resolution: int
        :param max_resolution: maximum resolution for image, px/meters
        :type max_resolution: int
        :param acquired_by: short symbol of the satellite that acquired the image (eg. "l8")
        :type acquired_by: str
        :param min_cloud_coverage: minimum cloud coverage percentage on acquired image
        :type min_cloud_coverage: int
        :param max_cloud_coverage: maximum cloud coverage percentage on acquired image
        :type max_cloud_coverage: int
        :param min_valid_data_coverage: minimum valid data coverage percentage on acquired image
        :type min_valid_data_coverage: int
        :param max_valid_data_coverage: maximum valid data coverage percentage on acquired image
    ...
    def download_satellite_image(self, metaimage, x=None, y=None, zoom=None, palette=None):
        ...
        :param palette: ID of the color palette of the downloaded image. Values are provided by `pyowm.agroapi10.enums.PaletteEnum`
