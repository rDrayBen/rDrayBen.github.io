...
class SatelliteImagerySearchResultSet:
    ...
    def __init__(self, polygon_id, list_of_dict, query_timestamp):
        ...
        :param polygon_id: the ID of the polygon that has been searched for image
        :type polygon_id: str
    ...
    def with_img_type(self, image_type):
        ...
        return list(filter(lambda x: x.image_type == image_type, self.metaimage))
    ...
    def with_preset(self, preset):
        ...
        return list(filter(lambda x: x.preset == preset, self.metaimage))
    ...
    def with_img_type_and_preset(self, image_type, preset):
        ...
        assert isinstance(image_type, ImageType)
        assert isinstance(preset, str)
        return list(filter(lambda x: x.image_type == image_type and x.preset == preset, self.metaimage))
